...
namespace WinFrogger
{
    ...
    class Game
    {
        ...
        private void Reset()
        {
            ...
            for (int i = 0; i < 3; i++) turtles.Add(new Turtle(Image.FromFile("data/textures/turtle.png"), Direction.Right, 608 - i * rnd.Next(128, 256), 128, 4, true, rnd.Next(120, 1200), true));
            ...
            for (int i = 0; i < 3; i++) trunks.Add(new Trunk(Image.FromFile("data/textures/trunk.png"), Direction.Left, -32 + i * rnd.Next(128, 256), 160, 4, true));
